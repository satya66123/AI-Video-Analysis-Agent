...
def test_execute_success():
    ...
    _, kwargs = (
        service.generate_complete_report.call_args
    )
...
def test_execute_with_empty_context():
    ...
    assert data["video_duration"] == "N/A"
    assert data["video_resolution"] == "N/A"
    assert data["video_fps"] == "N/A"
    assert data["video_format"] == "N/A"
    assert data["video_size"] == "N/A"

    assert data["audio_name"] == "N/A"
    assert data["audio_duration"] == "N/A"
    assert data["channels"] == "N/A"
    assert data["sample_rate"] == "N/A"
    assert data["audio_format"] == "N/A"
    assert data["audio_size"] == "N/A"

...
from ui.sidebar_agent import SidebarAgent
from ui.navigation_agent import NavigationAgent

from ui.upload_page_agent import UploadPageAgent
from ui.transcript_page_agent import TranscriptPageAgent
from ui.analysis_page_agent import AnalysisPageAgent
from ui.report_page_agent import ReportPageAgent
from ui.export_page_agent import ExportPageAgent
from ui.chat_page_agent import ChatPageAgent
...
class AppAgent:
    ...
    def __init__(self):
        ...
        self.pages = {
            ...
            "Upload Video": UploadPageAgent(),
            "Transcript": TranscriptPageAgent(),
            "Analysis": AnalysisPageAgent(),
            "Report": ReportPageAgent(),
            "Export": ExportPageAgent(),
            "AI Chat": ChatPageAgent(),
